...
namespace Library
{
    public class ApiLogEntry
    {
        ...
        public IHttpRouteData RequestRouteData { get; set; }                    // The request route data.
        public Dictionary<string, string> RequestHeaders { get; set; }                              // The request headers.
        ...
        public Dictionary<string, string> ResponseHeaders { get; set; }                                         // The response headers.
        public DateTime? ResponseTimestamp { get; set; }                                    // The response timestamp.
        public string LogReferenceId { get; set; }                                          // The reference id
    }
}
